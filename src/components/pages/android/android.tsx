...
import { AndroidTimelineSection } from "@/components/pages/android/sections/android-timeline-section";
  ...
  return (
    <main className="flex flex-1 flex-col">
      <PageInset className="flex flex-1 flex-col">
        <Hero title="Stop your phone from turning off" />
      </PageInset>
      <SectionSeparator />
      <PageInset>
        <SeoSection />
      ...
      <SectionSeparator />
      <PageInset>
        <PlatformLinksSection currentPageKey="android" />
      </PageInset>
      <SectionSeparator />
      <PageInset>
        <HowItWorksSection />
      ...
      <SectionSeparator />
      <PageInset>
        <FaqSection pageKey="android" />
      </PageInset>
      <SectionSeparator />
      <PageInset>
        <AndroidTimelineSection />
      </PageInset>
    </main>
  );
}
